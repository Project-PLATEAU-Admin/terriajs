...
import ClippingPlanesMixin from "./ClippingPlanesMixin";
...
>(Base: T) {
  abstract class Cesium3dTilesMixin extends ClippingPlanesMixin(
    ...
    modelBoundingSphere(): BoundingSphere | undefined {
    ...
    get mapItems() {
      ...
      if (clippingPlanesDataSource) {
        clippingPlanesDataSource.show = this.show;
      }
      return filterOutUndefined([this.tileset, clippingPlanesDataSource]);
    }
